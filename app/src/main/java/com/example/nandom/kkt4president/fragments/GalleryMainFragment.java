...
public class GalleryMainFragment extends Fragment {
    ...
    private static final String TAG = GalleryMainFragment.class.getSimpleName();
    ...
    public static GalleryMainFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_gallery_main, container, false);
