...
public class UrgentIssues extends AppCompatActivity {
    private CollapsingToolbarLayout collapsingToolbarLayout = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_urgent_issues);
        ...
        collapsingToolbarLayout.setTitle(getResources().getString(R.string.urgent_issues_title));
